...
function encriptarTexto() {
  ...
  return encriptacion;
    ...
    alert("Por favor ingrese un texto válido, solo se aceptan minusculas sin acentos");
    document.getElementById('inputText').value='';
}
}
...
function desencriptarTexto() {
   ...
   // document.getElementById('inputText').value='';
    ...
    return textoDesencriptado;
        ...
        alert("Por favor ingrese un texto valido,solo se aceptan minusculas sin acentos");
        document.getElementById('inputText').value='';
